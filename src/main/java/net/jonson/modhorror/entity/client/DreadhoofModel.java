...
public class DreadhoofModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = picior_drept2.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(46, 38).addBox(-1.0F, -5.0F, -1.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(-0.001F)), PartPose.offsetAndRotation(2.001F, -3.8645F, -0.1784F, -0.0873F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = picistang.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(40, 9).addBox(-3.0F, -5.0F, -1.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(-0.001F)), PartPose.offsetAndRotation(-1.999F, -3.908F, -0.1755F, -0.0873F, 0.0F, 0.0F));
		...
		PartDefinition bone4 = cap.addOrReplaceChild("bone4", CubeListBuilder.create().texOffs(0, 38).addBox(-4.0F, -22.6741F, -6.8385F, 8.0F, 8.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 20.0F, 4.0F));

		PartDefinition bone9 = bone4.addOrReplaceChild("bone9", CubeListBuilder.create(), PartPose.offset(0.0F, 4.0F, 0.0F));

		PartDefinition cube_r3 = bone9.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(38, 47).addBox(-1.0F, -1.655F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(-2.0F, -28.045F, -6.1667F, 0.0F, 0.0F, -0.1745F));
		...
		PartDefinition cube_r4 = bone8.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(48, 18).addBox(-1.2F, -1.6262F, -0.9075F, 2.0F, 1.8F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(2.2F, -29.6738F, -6.0925F, -0.2618F, 0.0F, 0.0F));

		PartDefinition cube_r5 = bone8.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(46, 47).addBox(-1.0F, -2.355F, -1.0F, 2.0F, 2.7F, 2.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(2.0F, -28.045F, -6.1667F, -0.1309F, 0.0F, 0.0F));
